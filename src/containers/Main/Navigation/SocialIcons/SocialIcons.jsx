...
/**
 * React-Pose poses for social icons [hidden, visible, rotate, hover]
 */
...
/**
 * Display social icons on left size of Navigation console
 */
class SocialIcons extends React.Component {
    ...
    /**
     * Analyze scroll position and determine if icons should be rendered
     */
    componentDidUpdate() {
    ...
    /**
     * Render icons slowly in a descending pattern
     * @param num   The current icon to render
     */
    renderIcon = (num) => {
            if (num <= ICON_COUNT) {
                const icon = "icon" + num;
    ...
    /**
     * Rotate social icons on an interval to increase page livelihood
     */
    rotateSocialIcon = () => {
